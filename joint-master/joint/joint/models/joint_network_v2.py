...
from joint.models.utility import Shift2d
from joint.models.feature_extractor import ResNet, ResNet6, ResNet8, ResNet8_mod
from joint.models.classifier import LinearClassifier
...
class DualNetwork(nn.Module):
    ...
    def forward(self, x: Tensor):
        orig_inp = x
        if self.blindspot:
            rotated = [joint.utils.rotate(x, rot) for rot in (0, 90, 180, 270)]
