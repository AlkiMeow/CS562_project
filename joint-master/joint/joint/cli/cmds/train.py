...
from joint.cli.cmds import Command
from joint.params import NoiseAlgorithm, NoiseValue, ConfigValue
from joint.train import resume_run, DenoiserTrainer
...
class TrainCommand(Command):
    ...
    def configure(self, parser: _SubParsersAction):
        ...
        start_parser.add_argument(
            ...
            choices=[c.value for c in joint.utils.list_constants(NoiseAlgorithm)],
        )
        start_parser.add_argument(
            "--noise_style",
            "-n",
        ...
        start_parser.add_argument(
            ...
            choices=[c.value for c in joint.utils.list_constants(NoiseValue)],
        )
