...
from joint.params import NoiseAlgorithm

from enum import Enum, auto
from typing import Union, Dict, Tuple, List, Optional
from numbers import Number
from joint.utils.data_format import DataFormat, DATA_FORMAT_DIM_INDEX, DataDim
...
class NoisyDataset(Dataset):
    ...
    def prepare_input(
        ...
        if self.algorithm == NoiseAlgorithm.NOISE_TO_VOID and self.training_mode:
            noisy_in, mask_coords = joint.utils.n2v_ups.manipulate(noisy_in, 5) # TODO use config for neighbourhood radius
        ...
        # N2N and N2V require noisy input and noisy reference images
            ...
            ref, ref_coeff = joint.utils.noise.add_style(clean, self.noise_style)
